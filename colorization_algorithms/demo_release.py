...
def main(filepath, model_dir):
	...
	parser.add_argument('-i','--img_path', type=str, default=filepath)  # default='imgs/ansel_adams3.jpg'
	...
	plt.imsave(f'{save_path}%s_eccv16.png'%opt.save_prefix, out_img_eccv16)
	plt.imsave(f'{save_path}%s_siggraph17.png'%opt.save_prefix, out_img_siggraph17)
